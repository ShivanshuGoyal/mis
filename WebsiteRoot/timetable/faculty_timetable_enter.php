...
<div id="view_table" >
	<center><h3><?php echo 'Timetable for'.$_POST['course'].' '.$_POST['branch'].' Semester '.$_POST['semester'].', Section '.$_POST['section'].' in Session ('.$_POST['session'].')'; ?></h3>
...
?>	
		<table width="90%" height="304" border="1" class="margin">
			...
			<?php    
				...
				echo '<form name="form" action="timetable_enter.php" method="post">';?>
			...
			<?php	
				$free_slot_query="select slot_id from timetable_info where course_id='".$_POST['course']."' and branch_id='".$_POST['branch']."' and section='".$_POST['section']."' and semester='".$_POST['semester']."' and session='".$_POST['session']."'";
			...
			$subject_id_query="select id,name from course_structure, course_branch_section, subjects where subjects.subject_id= course_structure.subject_id and  course_structure.course_structure_id=course_branch_section.course_structure_id and semester='".$_POST['semester']."' and course_id='".$_POST['course']."' and branch_id='".$_POST['branch']."' and section='".$_POST['section']."' and year='".$year."' ";
