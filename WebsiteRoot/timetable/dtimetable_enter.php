...
<?php	
	...
	$classroom_id_query="select classroom_id from timetable_classroom_classes where course_id='CMN' and branch_id='CMN' and semester='".$_POST['semester']."' and section='".$_POST['section']."'";
	...
	for($i=1;$i<=50;$i++){
		if(isset($_POST['subject'.$i])){
			...
			$sql="insert into timetable_info_firstyear Values('".$faculty."','".$subject."','".$_POST['section']."','".$classroom_id."','".$i."','".$_POST['semester']."','','".$_POST['session']."')";	
			if(!$mysqli->query($sql)){
        	echo "query:" . $sql;	
			}
		}
